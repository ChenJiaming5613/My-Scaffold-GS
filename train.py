        ...
        with torch.no_grad():
            ...
            if iteration < opt.update_until and iteration > opt.start_stat:
                ...
                if iteration > opt.update_from and iteration % opt.update_interval == 0:
                    gaussians.adjust_anchor(check_interval=opt.update_interval, success_threshold=opt.success_threshold, grad_threshold=opt.densify_grad_threshold, min_opacity=opt.min_opacity, color_var_threshold=opt.color_var_threshold)
